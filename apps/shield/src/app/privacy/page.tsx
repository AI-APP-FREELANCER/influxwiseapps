  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-sm leading-relaxed text-slate-600">
        ...
        <section><h2 className="text-lg font-bold text-slate-900 mb-2">2. How we use it</h2><p>Your data is used solely to operate TrustMark. We do not sell or share your data with third parties for advertising. We may share minimal data with AWS (hosting), Neon (database), and Upstash (caching) as necessary to run the service.</p></section>
