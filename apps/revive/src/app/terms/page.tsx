...
export default function Terms() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <p className="text-slate-500 text-sm mb-8">Last updated: July 2026 · Influxwise / ReviveRecurr</p>
      <div className="prose prose-slate max-w-none space-y-6 text-sm leading-relaxed text-slate-600">
        <section><h2 className="text-lg font-bold text-slate-900 mb-2">1. Service</h2><p>ReviveRecurr is operated by Influxwise (Bengaluru, India). By using our service you agree to these terms. We may update these terms — continued use constitutes acceptance.</p></section>
        ...
        <section><h2 className="text-lg font-bold text-slate-900 mb-2">4. Acceptable use</h2><p>You may not use ReviveRecurr to process illegal, harmful, or abusive content. We reserve the right to terminate access without notice for violations.</p></section>
        <section><h2 className="text-lg font-bold text-slate-900 mb-2">5. Limitation of liability</h2><p>ReviveRecurr is provided "as is". We are not liable for indirect, incidental, or consequential damages. Our total liability is limited to amounts paid in the 30 days prior to a claim.</p></section>
